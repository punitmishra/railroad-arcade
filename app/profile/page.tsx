  ...
  return (
    <div className="min-h-screen bg-[#050508]">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        {/* Profile Card */}
        <div className="rounded-2xl bg-gradient-to-br from-cyan-500/10 to-purple-500/10 border border-white/10 p-6 mb-6">
          <div className="flex items-start gap-6">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-2 -right-2 w-8 h-8 rounded-full bg-emerald-500 border-4 border-[#0a0a0f] flex items-center justify-center">
            ...
            <div className="text-right">
              <div className="text-3xl font-bold text-amber-400 flex items-center gap-2 justify-end">
                <CoinsIcon size={28} />
        ...
        {/* Unlocked Modules */}
        <div className="rounded-2xl bg-[#0c0c14] border border-white/10 p-6 mb-6">
            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  {isUnlocked && (
                    <div className="text-[10px] text-emerald-400 mt-1">Unlocked</div>
                  )}
                </div>
              );
            })}
...
function QuickLink({ href, icon, title, description, color }: {
  ...
  return (
    <a
      href={href}
      className={`group block p-4 rounded-xl bg-[#0c0c14] border border-white/10 ${colors[color]} transition-all`}
    >
